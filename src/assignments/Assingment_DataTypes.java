...
public class Assingment_DataTypes {
	...
	public static void main(String[] args) {
		...
		float bankAccount = 1000.50f;
		System.out.println("Amount of money in a customer's bank account: "+bankAccount);
		...
		System.out.println("Title of a book is: "+titleOfBook);
		
		//15.Number of employees in a company: 500
		int employees = 500;
		System.out.println("Number of employees in a company is: "+employees);
		
		//16.Time of an event: 2:30 PM
		
		String timeOfEvnet = "2:30PM";
		System.out.println("Time of an event is: "+timeOfEvnet);
